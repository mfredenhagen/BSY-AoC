...
class Puzzle7Test {
    ...
    @Test
    void solve() {
        Puzzle7.Puzzle7Result solve = Puzzle7.solve(TEST_INPUT);
        assertEquals("tknk", solve.BottomProgram);
        assertEquals(60, solve.CorrectedWeight);
    }

    @Test
    void spike() {
        Puzzle7.Puzzle7Result solve = Puzzle7.solve(INPUT);
        System.out.printf("Puzzle7: %s\nPuzzle7 a: %d\n", solve.BottomProgram, solve.CorrectedWeight);
        assertEquals("gmcrj", solve.BottomProgram);
        assertEquals(391, solve.CorrectedWeight);
    }
}