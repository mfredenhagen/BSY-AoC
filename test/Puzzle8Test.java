...
class Puzzle8Test {
    ...
    @Test
    void solve() {
        Puzzle8.Result result = Puzzle8.solve(TEST_INPUT);
        assertEquals(1, result.LargestValue);
        assertEquals(10, result.HighestValueDuringComputation);
    }

    @Test
    void spike() {
        Puzzle8.Result result = Puzzle8.solve(INPUT);
        System.out.printf("Puzzle8: %d\nPuzzle8 a: %d\n", result.LargestValue, result.HighestValueDuringComputation);
        assertEquals(3089, result.LargestValue);
        assertEquals(5391, result.HighestValueDuringComputation);
    }
